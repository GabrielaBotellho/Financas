...
// `amountBetween`: opcional — [min, max] em reais, pra regras que também
// dependem do valor (ex: o Pix de carona é sempre por volta de R$7).
const RULES = [
  // --- regras ensinadas por você ---
  { test: /pix/i, amountBetween: [5, 10], category: "Transporte - Carona", confidence: "alta" },
